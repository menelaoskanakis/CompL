...
from vissl.models.additional_modules import deeplabv3plus_resnet26
...
@register_model_trunk("deeplabv3plus_resnet26")
class Deeplabv3plusResNeXt26(nn.Module):
    """
    ...
    def __init__(self, model_config: AttrDict, model_name: str):
        super(Deeplabv3plusResNeXt26, self).__init__()
        ...
        model = getattr(deeplabv3plus_resnet26, 'resnet{}'.format(self.trunk_config.DEPTH))
        ...
        model = model(pretrained=self.trunk_config.PRETRAINED, path=pretrained_path,
