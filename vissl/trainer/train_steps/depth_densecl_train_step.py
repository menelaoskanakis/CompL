...
@register_train_step("depth_densecl_train_step")
def depth_densecl_train_step(task):
    """
    ...
    if len(sample['depth']) > 1:
        raise NotImplementedError('Currently only support depth for 1 dataset')
    else:
